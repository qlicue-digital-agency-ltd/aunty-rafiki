...
/// The direction in which a [Swiperable] can be dismissed.
enum DismissDirection {
  /// The [Swiperable] can be dismissed by dragging either up or down.
  vertical,

  /// The [Swiperable] can be dismissed by dragging either left or right.
  horizontal,

  /// The [Swiperable] can be dismissed by dragging in the reverse of the
  /// reading direction (e.g., from right to left in left-to-right languages).
  endToStart,

  /// The [Swiperable] can be dismissed by dragging in the reading direction
  /// (e.g., from left to right in left-to-right languages).
  startToEnd,

  /// The [Swiperable] can be dismissed by dragging up only.
  up,

  /// The [Swiperable] can be dismissed by dragging down only.
  down
}
...
/// non-null, the Swiperable widget animates its height (or width, whichever is
...
/// is specified it is stacked behind the Swiperable's child and is exposed when
/// the child moves.
///
/// The widget calls the [onDismissed] callback either after its size has
/// collapsed to zero (if [resizeDuration] is non-null) or immediately after
/// the slide animation (if [resizeDuration] is null). If the Swiperable is a
/// list item, it must have a key that distinguishes it from the other items and
/// its [onDismissed] callback must remove the item from the list.
class Swiperable extends StatefulWidget {
  /// Creates a widget that can be dismissed.
  ///
  /// The [key] argument must not be null because [Swiperable]s are commonly
...
class _DismissibleState extends State<Swiperable> with TickerProviderStateMixin, AutomaticKeepAliveClientMixin {
  @override
  void initState() {
    super.initState();
      ...
      assert(() {
        if (_resizeAnimation.status != AnimationStatus.forward) {
          ...
          throw FlutterError.fromParts(<DiagnosticsNode>[
            ErrorSummary('A dismissed Swiperable widget is still part of the tree.'),
            ErrorHint(
              'Make sure to implement the onDismissed handler and to immediately remove the Swiperable '
